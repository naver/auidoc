    ...
    */
    ...
    readResources = function(target, classname, type, extNames) {
        ...
        resourceList.forEach(function (filename) {
            ...
            console.log(Array(30).join('#'), filename);
        ...
        // target.screenshots = [ { description : value + '/' + classname + '/' + options.resourcedir } ];
...
Y.log('param name/type/descript missing: ' + stringlog(block), 'warn', 'docparser');
        ...
        'class': function(tagname, value, target, block) {
            ...
            target = readResources(target, fullname, 'manual', [ '.wiki', '.html', '.htm', '.doc', '.docx' ]);
        ...
        'keyword': function(tagname, value, target, block) {
            ...
            for (var i = 0, len = keywords.length; i < len; i++) {
                ...
                var keyworditem = this.keywords[keyword] = this.keywords[keyword] || { 'name' : keyword, 'tag' : 'tag' };
