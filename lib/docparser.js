...
YUI.add('docparser', function(Y) {
    ...
    */
    ...
    readResources = function(target, classname, type, extNames) {
        ...
        resourceList.forEach(function (filename) {
            ...
            if (extNames.indexOf(fileExt) === -1) { return; }
            ...
            // <meta name="description" content="UltraEdit는 노트패드를 대치하고 파일 크기 무제한, 10만 단어 맞춤법 검사">
