    ...
    var Server = {
        ...
        */
        routes: function() {
            ...
            app.get('/tags/:tag.html', Server.parse, function(req, res) {
                Server.tag(req, res);
            });
        ...
        */
        tag: function(req, res) {
            ...
            Y.log('Serving /tags/' + tagName + '.html', 'info', 'server');
            Server.builder.renderTag(function(html) {
                res.send(html);
            }, Server.builder.data.tags[tagName], (req.xhr ? 'xhr' : 'main'));
        },
        /**
        * `/` endpoint
        * @method home
