        ...
        */
        renderClass: function(cb, data, layout) {
            ...
            Y.prepare([DEFAULT_THEME, themeDir], self.getProjectMeta(), function(err, opts) {
                ...
                opts.meta = self.readResources(opts.meta, 'screenshot'); 
                opts.meta = self.readResources(opts.meta, 'demo'); 
                opts.meta = self.readResources(opts.meta, 'manual'); 
        ...
        readResources : function(meta, type) {
